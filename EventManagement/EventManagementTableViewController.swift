...
class EventManagementTableViewController: UITableViewController {
        ...
        //Mo ta cac su kien
        var Des_Monday: [String] = ["Description1", "Description2", "Description3"]
        var Des_Tuesday: [String] = ["Description1", "Description2", "Description3"]
        ...
        var Detail_Monday: [String] = ["Detail1", "Detail2", "Detail3"]
        var Detail_Tuesday: [String] = ["Detail1", "Detail2", "Detail3"]
